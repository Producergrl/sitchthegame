...
export const decks: Deck[] = [
  ...
  { id: 'bullying', slug: 'bullying', name: 'Bullying & Peer Pressure', description: 'Handle tough social situations and stand up for yourself and others.', age_band: '7-9', tags: ['bullying', 'peer pressure'], is_default: true, { id: 'bullying', slug: 'bullying', name: 'Bullying & Peer Pressure', description: 'Handle tough social situations and stand up for yourself and others.', age_band: '7-9', tags: ['bullying', 'peer pressure'], is_default: true, is_free: true, card_count: 4, icon: '💪', color: 'secondary' },
  // ── 10+ age band ──
  ...
  { id: 'street-smarts-10plus', slug: 'street-smarts-10plus', name: 'Street Smarts (10+)', description: 'Navigate real-world situations with confidence and good judgment.', age_band: '10+', tags: ['awareness', 'judgment'], { id: 'street-smarts-10plus', slug: 'street-smarts-10plus', name: 'Street Smarts (10+)', description: 'Navigate real-world situations with confidence and good judgment.', age_band: '10+', tags: ['awareness', 'judgment'], is_default: true, is_free: true, card_count: 0, icon: '🧠', color: 'help' },, slug: 'street-smarts-10plus', name: 'Street Smarts (10+)', description: 'Navigate real-world situations with confidence and good judgment.', age_band: '10+', tags: ['awareness', 'judgment'], is_default: true, is_free: true, card_count: 0, icon: '🧠', color: 'help' },
  // ── Teens age band ──
  { id: 'real-world-judgment-teens', slug: 'real-world-judgment-teens', name: 'Real-World Judgment (Teens)', description: 'Navigate adult-ish situations with confidence and common sense.', age_band: 'teens', tags: ['judgment', 'digital-awareness'], { id: 'real-world-judgment-teens', slug: 'real-world-judgment-teens', name: 'Real-World Judgment (Teens)', description: 'Navigate adult-ish situations with confidence and common sense.', age_band: 'teens', tags: ['judgment', 'digital-awareness'], is_default: true, is_free: true, card_count: 0, icon: '🧭', color: 'gentle' },, slug: 'real-world-judgment-teens', name: 'Real-World Judgment (Teens)', description: 'Navigate adult-ish situations with confidence and common sense.', age_band: 'teens', tags: ['judgment', 'digital-awareness'], is_default: true, is_free: true, card_count: 0, icon: '🧭', color: 'gentle' },
];
