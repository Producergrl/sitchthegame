...
export const decks: Deck[] = [
  ...
  { id: 'trusted-adults-4-6', slug: 'trusted-adults-4-6', name: 'Trusted Adults (4–6)', description: 'Know who to turn to and how to stay safe with strangers.', age_band: '4-6', tags: ['stranger-safety'], is_default: true, is_free: false, card_count: 0, icon: '🏠', color: 'safe' },
  { id: 'secrets-4-6', slug: 'secrets-4-6', name: 'Safe & Unsafe Secrets (4–6)', description: 'Learn the difference between surprises and secrets that should be told.', age_band: '4-6', tags: ['body-safety', 'secrets'], is_default: true, is_free: false, card_count: 0, icon: '🤫', color: 'caution' },
  ...
  { id: 'trusted-adults', slug: 'trusted-adults', name: 'Trusted Adults & Safe Places', description: 'Know who to turn to and where to go when you need help.', age_band: '4-6', tags: ['trusted adults', 'safe places'], is_default: true, is_free: false, card_count: 4, icon: '🏠', color: 'safe' },
  // ── 7-9 age band ──
  ...
  { id: 'digital-safety-7-9', slug: 'digital-safety-7-9', name: 'Digital Safety (7–9)', description: 'Stay safe from strangers and scams online.', age_band: '7-9', tags: ['online-safety'], is_default: true, is_free: false, card_count: 0, icon: '💻', color: 'help' },
  ...
  { id: 'bullying', slug: 'bullying', name: 'Bullying & Peer Pressure', description: 'Handle tough social situations and stand up for yourself and others.', age_band: '7-9', tags: ['bullying', 'peer pressure'], is_default: true, is_free: false, card_count: 4, icon: '💪', color: 'secondary' },
  // ── 10+ age band ──
  ...
  { id: 'street-smarts-10plus', slug: 'street-smarts-10plus', name: 'Street Smarts (10+)', description: 'Navigate real-world situations with confidence and good judgment.', age_band: '10+', tags: ['awareness', 'judgment'], is_default: true, is_free: false, card_count: 0, icon: '🧠', color: 'help' },
  // ── Teens age band ──
  { id: 'real-world-judgment-teens', slug: 'real-world-judgment-teens', name: 'Real-World Judgment (Teens)', description: 'Navigate adult-ish situations with confidence and common sense.', age_band: 'teens', tags: ['judgment', 'digital-awareness'], is_default: true, is_free: false, card_count: 0, icon: '🧭', color: 'gentle' },
];
