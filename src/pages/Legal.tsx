...
const Legal = () => (
  <div className="min-h-screen bg-background text-foreground p-6 max-w-2xl mx-auto">
    ...
    <p className="text-sm text-muted-foreground mb-10 italic">Here's the Sitch Game</p>
    ...
    <section className="space-y-4 text-sm text-muted-foreground mb-10">
      ...
      <p>The distinctive structure, format, and gameplay methodology of Here's the Sitch constitute proprietary creative work. Any attempt to replicate or commercially exploit the game format without authorization is prohibited.</p> proprietary creative work. Any attempt to replicate or commercially exploit the game format without authorization is prohibited.</p>
    </section>
    ...
    <section className="space-y-4 text-sm text-muted-foreground mb-10">
      ...
      <p>The Here's the Sitch app respects user privacy and is committed to protecting personal information.</p> and is committed to protecting personal information.</p>
